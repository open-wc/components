...
The following example demonstrates the minimum setup required to render a table.
...
Currently, there is no support for tables using this attribute. trying to use it with multiple tables on the same page will result in fighting of the tables.
...
Enable this behavior using `render-mode="detail"` and provide a `renderDetail` callback.

The callback receives the selected row and returns the content that should be rendered when the row is expanded.
...
Rows sharing the same group identifier are rendered together.
...
| ------------------- | --------- | ------------- | ----------- |
| `filter-mode`       | `string`  | `"hidden"`    |             |
| `render-mode`       | `string`  | `"simple"`    |             |
| `save-state-to-url` | `boolean` | `false`       |             |
| `sticky-header`     | `boolean` | `false`       |             |
| `show-info`         | `boolean` | `false`       |             |
| `action-tab-active` | `string`  | `""`          |             |
| `store-name-prefix` | `string`  | `"owc-table"` |             |
...
| Property            | Type                                                              | Description |
| ------------------- | ----------------------------------------------------------------- | ----------- |
| `handleData`        | `(options?: { jsonFilters?: NestedJsonFilters }) => Promise<T[]>` |             |
...
| Property               | Type                                                                       | Description |
| ---------------------- | -------------------------------------------------------------------------- | ----------- |
| `filterMode`           | `"hidden" \| "global-search" \| "builder" \| "global-search-with-builder"` |             |
| `filter`               | `Filter<unknown> \| null`                                                  |             |
| `jsonFilters`          | `NestedJsonFilters`                                                        |             |
| `highlightFilter`      | `Filter<unknown> \| null`                                                  |             |
| `highlightJsonFilters` | `NestedJsonFilters`                                                        |             |
...
| `openDetails`         | `(string \| number)[]`                      |             |
| `getRowLinkSettings`  | `(row: T) => RowLinkSettings`               |             |
...
| Property          | Type                            | Description |
| ----------------- | ------------------------------- | ----------- |
| `customStyles`    | `CSSResult \| TemplateResult`   |             |
| `virtualizerMode` | `"auto" \| "always" \| "never"` |             |

### Internal Read-only Properties

These properties are exposed but are primarily intended for internal use.

| Property            | Type                    | Description |
| ------------------- | ----------------------- | ----------- |
| `_hasInfoBlock`     | `boolean`               |             |
| `loadedDetailIdSet` | `Set<string \| number>` |             |
| `tableWidth`        | `number`                |             |
